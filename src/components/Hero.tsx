...
export default function Hero() {
  return (
    <section id="home" className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-vineyard-deep">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        ...
        >
          <span className="inline-block text-gold-accent tracking-[0.4em] uppercase text-[10px] md:text-xs font-bold mb-8">
            Est. 2024 — Phrom Buri, Sing Buri
          </span>
          
          <h1 className="text-6xl md:text-8xl lg:text-[10rem] text-white font-serif leading-[0.85] mb-12">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 mt-16">
            ...
            <p className="text-white/60 font-serif italic text-lg md:text-xl max-w-md">
              "สัมผัสประสบการณ์สวนองุ่นสดใหม่จากไร่ พร้อมไวน์คุณภาพที่รังสรรค์ด้วยความใส่ใจ"
            </p>
            <div className="h-[1px] w-12 bg-gold-accent/30 hidden md:block" />
          </div>
